...
def index(master, username):
  ...
  context = {
    'username': username,
    'latest_update_items': [{"kid": item["sk"].split("#")[1], "slug": item["clsi_sk"].split("#")[1], "latest_update": item["latest_update"], "memo": item.get("memo", None)} for item in latest_update_items]
  }
